...
var FACTORY_ADDRESS_MAP =
  ...
  (_FACTORY_ADDRESS_MAP[exports.ChainId.MAINNET] = FACTORY_ADDRESS),
  (_FACTORY_ADDRESS_MAP[exports.ChainId.TESTNET] = '0xBa5FBa5A47f7711C3bF4ca035224c95B3cE2E9C9'),
  _FACTORY_ADDRESS_MAP)
var INIT_CODE_HASH = '0x7ae6954210575e79ea2402d23bc6a59c4146a6e6296118aa8b99c747afec8acf'
var INIT_CODE_HASH_MAP =
  ((_INIT_CODE_HASH_MAP = {}),
  (_INIT_CODE_HASH_MAP[exports.ChainId.MAINNET] = INIT_CODE_HASH),
  (_INIT_CODE_HASH_MAP[exports.ChainId.TESTNET] = '0x37ee4b019c70d4c7214fd65ea00786a310364861a8df23eba1a2dfbc247b6408'),
  _INIT_CODE_HASH_MAP)
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    if (
      ((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE === void 0
        ? void 0
        : _PAIR_ADDRESS_CACHE[key]) === undefined
    ) {
      var _extends2
      ...
      PAIR_ADDRESS_CACHE = _extends(
        ...
        PAIR_ADDRESS_CACHE,
        ((_extends2 = {}),
        (_extends2[key] = address.getCreate2Address(
...
var Fetcher = /*#__PURE__*/ (function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IPancakePair, provider).getReserves()).then(function (
        _ref
      ) {
