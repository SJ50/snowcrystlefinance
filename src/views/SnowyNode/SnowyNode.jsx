            ...
            <Card className={classes.gridItem} style={{ background: '#161414', borderRadius: '15px', height: '100px' }}>
              <CardContent style={{ textAlign: 'center', color: '#5686d6' }}>
                ...
                <Typography>
                  {nodes[0] && (
                    <>
                      <b style={{ color: '#fff', marginRight: '0px' }}>{nodes[0].toString()}</b> |{' '}
              ...
              <CardContent style={{ textAlign: 'center' }}>
                ...
                <Typography>
                  {bank.depositTokenName === 'GRAPE-SNOW-LP'
                    ? (Number(userDetails.total_claims) / 1e18).toFixed(3)
                    : (Number(userDetails.total_claims) / 1e18).toFixed(10)}{' '}
                </Typography>
              </CardContent>
            </Card>
          </Grid>
        ...
        <StyledBoardroom>
          ...
          {bank.depositTokenName === 'GRAPE-SNOW-LP' ? (
            <Card style={{ borderRadius: '15px', marginTop: '20px' }}>
              <CardContent
                style={{ background: 'linear-gradient(90deg, #8fbdeb 14%, #a2c8ee 100%)', borderRadius: '15px' }}
              >
                <StyledLink
                  href={
                    'https://traderjoexyz.com/pool/0x4eeA14405B658EaDBD981f2540691F1b9F86aB48/0x5541d83efad1f281571b343977648b75d95cdac2'
                  }
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  <span style={{ color: '#fff' }}>Provide liquidity for GRAPE-SNOW on Joe</span>
                </StyledLink>
              </CardContent>
            </Card>
          ) : null}
